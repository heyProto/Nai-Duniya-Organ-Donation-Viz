...
ProtoGraph.Card.toOrganCoverVizCard.prototype.renderSEO = function (data) {
  this.renderMode = 'SEO';
  return this.containerInstance.renderSEO();
}

ProtoGraph.Card.toOrganCoverVizCard.prototype.renderEdit = function (onPublishCallback) {
  this.mode = 'edit';
